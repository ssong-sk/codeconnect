...
public class HireService implements HireServiceInter {
	...
	@Override
	public List<HireDto> searchHire(String search_job, String search_tech, String search_region, String search_career) {
		return mapper.searchHire(search_job, search_tech, search_region, search_career);
	}
