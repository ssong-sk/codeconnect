...
public interface CustomerServiceInter {
    ...
    List<CustomerDto> getDatasByType(@Param("cus_top_type") String cus_top_type); //타입별 데이터 조회
    int getCountByType(@Param("cus_top_type") String cus_top_type); //타입별 게시글 수 조회
    ...
    /*
    List<CustomerDto> getDatasByType(String cus_top_type); //타입별 데이터 조회
