...
<body>
	...
	<c:if test="${sessionScope.c_loginok!=null }">
		...
		<button type="button" class="btn btn-danger"
			onclick="location.href='/company/logoutprocess'" id="btnlogout">기업
			로그아웃</button>
	</c:if>
	...
	<br>
	<button class="btn btn-info">공고 등록하기</button><br><br>
	...
	<button class="btn btn-info" onclick="location.href='companyupdate'">기업
		정보수정</button><br><br>

	<button class="btn btn-info" onclick="location.href='intromain'">기업
		소개하기</button>
