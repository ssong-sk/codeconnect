...
.BrandNewNavLinks_BrandNewNavLinks___ndTt,
	.BrandNewNavLinks_BrandNewNavLinks__logo__PVLJM {
	display: flex;
	justify-content: space-between;
	align-items: center;
}

.BrandNewNavLinks_BrandNewNavLinks__links__V6A0u {
	display: flex;
	gap: 32px;
}

.BrandNewNavLinks_BrandNewNavLinks__links__V6A0u>a {
	color: #171719;
	white-space: nowrap;
}

.Typography_Typography__weightMedium__GXnOM {
	font-weight: 500;
}
...
.Typography_Typography__root__RdAI1 {
	margin: 0;
}
...
.Footer_footerText__WK_1o>p span {
	word-break: keep-all;
	text-rendering: optimizeLegibility;
	overflow-wrap: break-word;
}

.Footer_Divider__fijsw {
	height: 1px;
	width: 100%;
...
.Footer_socialClass__LNZhe>span {
	color: rgba(55, 56, 60, .61);
}
			...
			<div class="BrandNewNavLinks_BrandNewNavLinks___ndTt">
				<a class="BrandNewNavLinks_BrandNewNavLinks__logo__PVLJM"
					...
					data-fnb-kind="home" data-page-path="/" href="/"><svg
						...
						<mask id="WantedLogoSymbolMask_:R4sr6:" style="mask-type:alpha"
						...
						<g mask="url(#WantedLogoSymbolMask_:R4sr6:)">
						...
						<path
							...
							fill="url(#WantedLogoGradient0Linear_:R4sr6:)"></path>
						<path
							d="M441 996.5V361C441 307.98 480.98 268 534 268H556.18L556 1006.92L441 996.5Z"
							fill="url(#WantedLogoGradient1Linear_:R4sr6:)"></path>
						<mask id="mask1_:R4sr6:" style="mask-type:alpha"
							maskUnits="userSpaceOnUse" x="441" y="268" width="110"
							height="110">
						<path d="M441 378H551V268H534C480.98 268 441 307.98 441 361V378Z"></path></mask>
						<g mask="url(#mask1_:R4sr6:)">
						<rect x="441" y="268" width="220" height="220"
							fill="url(#WantedLogoGradientFallback1_:R4sr6:)"></rect>
						<foreignObject x="441" y="268" width="220" height="220"
							style="background:conic-gradient(#2AB8FF 0deg, #20BAFF 180deg, #20BAFF 270deg, #2AB8FF 360deg)"></foreignObject></g>
						<mask id="mask2_:R4sr6:" style="mask-type:alpha"
							maskUnits="userSpaceOnUse" x="28" y="630" width="158"
							height="189">
						<path
						...
						<g mask="url(#mask2_:R4sr6:)">
						<rect x="28" y="582.5" width="315" height="315"
							fill="url(#WantedLogoGradientFallback2_:R4sr6:)"></rect>
						<foreignObject x="28" y="582.5" width="315" height="315"
							style="background:conic-gradient(#717EFF 0deg, #4E76FF 90deg, #1368FF 180deg, #1A6AFF 225deg, #316FFF 270deg, #5076FF 315deg, #717EFF 360deg)"></foreignObject></g>
						<mask id="mask3_:R4sr6:" style="mask-type:alpha"
							maskUnits="userSpaceOnUse" x="367" y="999" width="190"
							height="158">
						<path
						...
						<g mask="url(#mask3_:R4sr6:)">
						<rect x="288.5" y="843" width="314" height="314"
							fill="url(#WantedLogoGradientFallback3_:R4sr6:)"></rect>
						<foreignObject x="288.5" y="843" width="314" height="314"
							style="background:conic-gradient(#0091FF 0deg, #0096FF 90deg, #0089FF 135deg, #007EFF 180deg, #0075FF 225deg, #006EFF 270deg, #0091FF 360deg)"></foreignObject></g>
						<path d="M441 998.5L556 1033.5V950.34H441V998.5Z"
							fill="url(#WantedLogoGradient5Linear_:R4sr6:)"></path>
						<path d="M556 1058.5L441 998.5L441 961L556 1001L556 1058.5Z"
							fill="url(#WantedLogoGradient6Linear_:R4sr6:)"></path>
						<path d="M556 725H441V830.5H556V725Z"
							fill="url(#WantedLogoGradient7Linear_:R4sr6:)"></path>
						<mask id="mask4_:R4sr6:" style="mask-type:alpha"
							maskUnits="userSpaceOnUse" x="809" y="630" width="511"
							height="511">
						<path
						...
						<g mask="url(#mask4_:R4sr6:)">
						<rect x="809" y="630" width="511" height="511"
							fill="url(#WantedLogoGradientFallback4_:R4sr6:)"></rect>
						<foreignObject x="809" y="630" width="511" height="511"
							style="background:conic-gradient(#FF5A00 0deg, #FF5E0F 90deg, #FF7259 180deg, #FF8EBD 270deg, #FF9FFE 315deg, #FF5A00 360deg)"></foreignObject></g>
						<rect x="809" y="739" width="115" height="132" fill="#FF8EBD"></rect>
						<mask id="mask5_:R4sr6:" style="mask-type:alpha"
							maskUnits="userSpaceOnUse" x="28" y="630" width="1292"
							height="512">
						<path
						...
						<g mask="url(#mask5_:R4sr6:)">
						<path d="M1064 630H176.19L186 745H1064V630Z"
							fill="url(#WantedLogoGradient9Linear_:R4sr6:)"></path></g>
						<path d="M1011.5 745V630H904V745H1011.5Z"
							fill="url(#WantedLogoGradient10Linear_:R4sr6:)"></path>
						<mask id="mask6_:R4sr6:" style="mask-type:alpha"
							maskUnits="userSpaceOnUse" x="550" y="268" width="374"
							height="617">
						<path
						...
						<g mask="url(#mask6_:R4sr6:)">
						<path
							d="M809 268V885H924V360C924 334.69 914.51 311.35 897.29 294.27C880.2 277.33 857.01 268 832 268H809Z"
							fill="url(#WantedLogoGradient11Linear_:R4sr6:)"></path></g>
						<path d="M815 268H550V384H815V268Z"
							fill="url(#WantedLogoGradient12Linear_:R4sr6:)"></path>
						<mask id="mask7_:R4sr6:" style="mask-type:alpha"
							maskUnits="userSpaceOnUse" x="812" y="268" width="112"
							height="111">
						<path
							d="M832 268H812.5V378.5H924V360C924 334.69 914.51 311.35 897.29 294.27C880.2 277.33 857.01 268 832 268Z"
							fill="url(#WantedLogoGradient13Linear_:R4sr6:)"></path></mask>
						<g mask="url(#mask7_:R4sr6:)">
						<rect x="691" y="257" width="243" height="243"
							fill="url(#WantedLogoGradientFallback5_:R4sr6:)"></rect>
						<foreignObject x="691" y="257" width="243" height="243"
							style="background:conic-gradient(#6DB1FF 0deg, #7BB0FF 45deg, #8FADFF 90deg, #B4A8FF 180deg, #6DB1FF 360deg)"></foreignObject></g></g>
						<path
						...
						<defs>
						<linearGradient id="WantedLogoGradient0Linear_:R4sr6:"
							x1="27.7716" y1="630.227" x2="555.522" y2="1157.48"
						...
						<linearGradient id="WantedLogoGradient1Linear_:R4sr6:" x1="498.59"
						...
						<linearGradient id="WantedLogoGradient5Linear_:R4sr6:" x1="498.5"
							y1="950.34" x2="498.5" y2="1033.49"
							gradientUnits="userSpaceOnUse">
						<stop stop-color="#009FFF"></stop>
						<stop offset="0.578979" stop-color="#0094FF"></stop>
						<stop offset="1" stop-color="#0092FF"></stop></linearGradient>
						<linearGradient id="WantedLogoGradient6Linear_:R4sr6:"
							x1="510.338" y1="982.668" x2="496.815" y2="1025.94"
							gradientUnits="userSpaceOnUse">
						...
						<linearGradient id="WantedLogoGradient7Linear_:R4sr6:" x1="498.5"
						...
						<linearGradient id="WantedLogoGradient9Linear_:R4sr6:" x1="176"
						...
						<linearGradient id="WantedLogoGradient10Linear_:R4sr6:" x1="914.8"
						...
						<linearGradient id="WantedLogoGradient11Linear_:R4sr6:" x1="866.5"
						...
						<linearGradient id="WantedLogoGradient12Linear_:R4sr6:" x1="550"
						...
						<linearGradient id="WantedLogoGradient13Linear_:R4sr6:" x1="869.5"
