    ...
    <form action="${pageContext.request.contextPath}/customer/noticeupdate" method="post" enctype="multipart/form-data">
        ...
        <div>
            ...
            <select id="category" name="cus_category" required>
                <option value="공지" ${dto.cus_category == '공지' ? 'selected' : ''}>공지</option>
                <option value="안내" ${dto.cus_category == '안내' ? 'selected' : ''}>안내</option>
                <option value="기타" ${dto.cus_category == '기타' ? 'selected' : ''}>기타</option>
            </select>
        </div>
        <div>
