...
<div class="container">
    <div class="company-info">
        ...
        <div id="map">
            <iframe id="mapIframe" width="600" height="450" style="border:0" allowfullscreen="" loading="lazy" src="https://www.google.com/maps/embed/v1/place?key=YOUR_GOOGLE_MAPS_API_KEY&q=${cdto.c_addr}"></iframe>
        </div>
    </div>
