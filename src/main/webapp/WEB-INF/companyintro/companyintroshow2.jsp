		...
		<div class="company-info">
			...
			<div class="map-container">
				...
				<div class="ratings-container">
					...
					<c:if test="${sessionScope.loginok == null}">
						<button type="button" class="btn btn-primary"
							onclick="alert('로그인이 필요합니다.');">자세히 보기</button>
					</c:if>
				</div>
			</div>
		</div>
				...
				<div class="modal-body">
					<form id="reviewForm">
						...
						<div class="form-group">
							...
							<div class="rating">
								<input type="radio" id="cr_environment5" name="cr_environment"
									value="5"><label for="cr_environment5" title="5 stars"></label>
								<input type="radio" id="cr_environment4" name="cr_environment"
									value="4"><label for="cr_environment4" title="4 stars"></label>
								<input type="radio" id="cr_environment3" name="cr_environment"
									value="3"><label for="cr_environment3" title="3 stars"></label>
								<input type="radio" id="cr_environment2" name="cr_environment"
									value="2"><label for="cr_environment2" title="2 stars"></label>
								<input type="radio" id="cr_environment1" name="cr_environment"
									value="1"><label for="cr_environment1" title="1 star"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="rating">
								<input type="radio" id="cr_culture5" name="cr_culture" value="5"><label
									for="cr_culture5" title="5 stars"></label> <input type="radio"
									id="cr_culture4" name="cr_culture" value="4"><label
									for="cr_culture4" title="4 stars"></label> <input type="radio"
									id="cr_culture3" name="cr_culture" value="3"><label
									for="cr_culture3" title="3 stars"></label> <input type="radio"
									id="cr_culture2" name="cr_culture" value="2"><label
									for="cr_culture2" title="2 stars"></label> <input type="radio"
									id="cr_culture1" name="cr_culture" value="1"><label
									for="cr_culture1" title="1 star"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="rating">
								<input type="radio" id="cr_possibility5" name="cr_possibility"
									value="5"><label for="cr_possibility5" title="5 stars"></label>
								<input type="radio" id="cr_possibility4" name="cr_possibility"
									value="4"><label for="cr_possibility4" title="4 stars"></label>
								<input type="radio" id="cr_possibility3" name="cr_possibility"
									value="3"><label for="cr_possibility3" title="3 stars"></label>
								<input type="radio" id="cr_possibility2" name="cr_possibility"
									value="2"><label for="cr_possibility2" title="2 stars"></label>
								<input type="radio" id="cr_possibility1" name="cr_possibility"
									value="1"><label for="cr_possibility1" title="1 star"></label>
							</div>
						</div>
