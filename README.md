...
- ### 🐻김태윤 
  ...
  - 상세 기능 
    ...
    - 로그인 : 저장된 회원의 정보 사용
    - 메인페이지 : 사용자가 채용,기업,이력서,커뮤니티 등으로 이동
    - 마이페이지 : 회사 북마크,관심회사 / 회원 지원현황 , 이력서 작성률 확인 / 회원 정보 수정 및 탈퇴
...
- ### 🐼변효영 
  ...
  - 상세 기능
    - 커뮤니티 소셜 페이지 (실시간 전체글, 이번 주 인기글, 주제별 커뮤니티) 
    - 커뮤니티 소셜 게시글 / 댓글 CRUD 기능
    - 커뮤니티 현직자 인터뷰 페이지
    - 커뮤니티 현직자 인터뷰 게시글 CRUD 기능
    - 고객센터 페이지 (공지사항, 이벤트, 1:1 문의)
    - 고객센터 전체 게시글 CRUD 기능
    - 고객센터 1:1 문의 관리자 답변 CRUD 기능
 
- ### 🐙송승경 
  - GitHub 주소 : https://github.com/ssong-sk
  - 담당 역할 : 풀스택, 이력서 관련 페이지 구성
  - 상세 기능
    - 이력서 메인 홈 (최근 이력서 이미지, 기능 별 갯수, 채용공고 등)
    - 이력서 등록 CRUD 기능 / 미리보기 (등록 메뉴 선택 시 이력서 생성)
    - 이력서 현황 - 희망근무조건 등 리스트 출력 (최대 10개까지 등록 가능)
    - 이력서 지원현황 - 이력서 지원 내역 리스트 출력
    - 채용공고 스크랩 -리스트 출력
    - 기업 스크랩 - 리스트 출력
...
- ### 🐱이병준 
  ...
  - 담당 역할 : 풀스택, 채용공고 관련 페이지 구성, 전체적인 검색 기능 구현
  - 상세 기능 :
    - 채용공고 페이지 출력
    - 채용공고 카테고리별 검색 기능
    - 채용공고 등록
...
<div><h4>IDE</h4>
    ...
    <img src="https://img.shields.io/badge/MyBatis-FF9E0F?style=flat&logo=MyBatis&logoColor=white">
...
### 변효영
##### 커뮤니티 소셜 홈
https://github.com/ssong-sk/codeconnect/assets/142892132/20deb4d7-db41-440e-bb40-590b8cbdaf02
#####
https://github.com/ssong-sk/codeconnect/assets/142892132/74b155f8-d8eb-48e6-a993-8a6f85b2ef9f
##### 커뮤니티 소셜 CRUD
https://github.com/ssong-sk/codeconnect/assets/142892132/cf1af746-d540-4301-a328-9c23a15a1393
##### 커뮤니티 현직자 인터뷰
https://github.com/ssong-sk/codeconnect/assets/142892132/2f662dc2-d375-42fa-9e9c-1b949eacac9d
##### 고객센터 공지사항, 이벤트
https://github.com/ssong-sk/codeconnect/assets/142892132/5d5bd8d7-42ee-4d91-8460-5332d0314c6d
##### 고객센터 1:1 문의
https://github.com/ssong-sk/codeconnect/assets/142892132/e8291a4b-4219-4357-9988-f16cab9894ce
